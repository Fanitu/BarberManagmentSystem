...
const ServiceSection = () => {
  ...
  const startEdit = (item) => {
    ...
    setEditShopPercent(String(item.shopPercent));
  };
  ...
  return (
    <section className={styles.section}>
      ...
      <form onSubmit={handleCreate} className={styles.form}>
        ...
        <label className={styles.label}>
          ...
          <input
            ...
            max="100"
            value={shopPercent}
            onChange={(e) => setShopPercent(e.target.value)}
            required
          />
        </label>
      ...
      <h3 className={styles.subheading}>Service List</h3>
          ...
          editingId === item._id ? (
            <li key={item._id} className={styles.editRow}>
              ...
              <input
                className={`${styles.editInput} ${styles.editPriceInput} mono-figure`}
                type="number"
                value={editShopPercent}
                onChange={(e) => setEditShopPercent(e.target.value)}
              />
            ...
            <li key={item._id} className={styles.row}>
              ...
              <span className="mono-figure">{item.shopPercent}%</span>
